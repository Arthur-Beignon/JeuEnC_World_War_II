        ...
        else
        {
            ...
            if(choix == 1)
            {
               choix_fr("france_21");
                ...
                {
                    choix_fr("france_212_222");
                    choix = 1;
                    if(choix == 1) /*USAAAAAAAAAAAAAAAAAA*/
                    {
                        show_map("map_pearl_habor");
                        afficherHistoire (25, "25.txt");
                        choix_fr("accueil_usa");  
                        if(choix ==1)
                        {
                            choix_fr("usa_1");
                            if(choix == 1)
                            {
                                ...
                                if (choix == 1)
                                {
                                    ...
                                    {   
                                        show_map("map_stalingrad");
                                        afficherHistoire(50, "50.txt");
                                        choix_fr("accueil_urss");
                                        if (choix == 1)
                                        {
                                            choix_fr("urss_1");
                                            if (choix == 1)
